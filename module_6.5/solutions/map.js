...
// CODE STARTS HERE
fetch("../../data/sample_landparcels.geojson")
  .then((response) => response.json())
  .then((data) => {

    const detailData = handleCounts(data);
    console.log(detailData);

    handleChart("chart", detailData);

    // Ingesting of GeoJSON
    var landParcels = L.geoJSON(data, {
      style: handleFeatures,
      onEachFeature: handlePopups,
    }).addTo(map);
